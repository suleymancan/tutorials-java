...
<body>
	...
	<section class="container">
		<!-- watch out modelAttribute ! spring in kendi html tagları form, input, select vs-->
		<form:form  modelAttribute="newProduct" class="form-horizontal" method="post">
			...
			<%--path, modeldeki property alanları ile aynı isimde olmalı. --%>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-lg-10">				
												...
												<%-- bunları dinamik yapmak gerek. Bunun icin ModelAttribute'den faydalanabiliriz. 	
						...
						--%>	
						  				 <%--items'a manufacturerList'i veriyoruz --%>
