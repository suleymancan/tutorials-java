...
<!-- context path dinamik bir sekilde calisiyor. -->
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
 ...
 <!-- c url linkin basina proje dosyasının adını ekliyor. fullpath -->
<link rel="stylesheet" type="text/css" media="screen" href="<c:url value="/resources/css/sidebar.css" />" /> 
<link rel="stylesheet" type="text/css" media="screen" href="<c:url value="/resources/css/bootstrap.min.css" />" />
<script src="<c:url value="/resources/js/jquery.min.js" />"></script>
<script>

<%--matrix variable: url'de parametreyi ", " seklinde ayarlamak icin js" --%>
