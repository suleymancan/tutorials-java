...
public class ProductController {
	...
	// public String addProductPageSubmit(@ModelAttribute("newProduct") Product
	// productToAdded) {
	...
	// VALIDASYON Hibernate
	@RequestMapping(value = "/add", method = RequestMethod.POST)
	public String addProductPageSubmit(@ModelAttribute("newProduct") @Valid Product productToAdded,
			BindingResult bindingResult) {
