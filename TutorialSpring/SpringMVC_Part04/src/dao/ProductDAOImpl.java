...
public class ProductDAOImpl implements ProductDAO {
	...
	// bu dalatar injavawetrust (levent ergüder'e) ait
	 ...
	 * (non-Javadoc)
	 * 
	 * @see dao.ProductDAO#getProductsByBrands(java.util.List)
	 */
	@Override
	...
	// burada jpql ile save atabiliriz ama bu örnekte basitce listeye ekleme
	// yapacagiz.
