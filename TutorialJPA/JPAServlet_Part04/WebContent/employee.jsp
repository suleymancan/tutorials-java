	...
	<!-- jstl kullanmak için taglib ekliyoruz -->
							...
							<form class="form-horizontal" action="employeeController"
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<!-- buralarda name alanı olmazsa req.getParameter ile alamayız. -->
							...
							<div class="table-responsive">
								<table id="example" class="table table-striped table-bordered">
									...
									<tbody>
										...
										<!-- jstl grameri
						datayı listeliyorum. req set attribute'de allEmployees ismi olmalı.
						 -->
										...
										<c:forEach items="${allEmployees}" var="employee">
											<tr>
												...
												<td><a
													href="employeeController?employeeId=${employee.id}"
